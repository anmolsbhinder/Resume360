  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const contributions = await getContributions('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', username);
    ...
    <div>
      {userInfo ? (
        <div>
          ...
          {contributionData ? (
            <p>Contributions: {contributionData.user.contributionsCollection.contributionCalendar.totalContributions}</p>
          ) : (
